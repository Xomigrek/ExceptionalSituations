...
public class ProductManagerTest {
    ...
    Smartphone smartphone2 = new Smartphone(2, "phone2", 100, "manufacture1");
    Smartphone smartphone3 = new Smartphone(3, "phone3", 100, "manufacture1");
    Smartphone smartphone4 = new Smartphone(4, "smartphone4", 100, "manufacture1");
    @Test
